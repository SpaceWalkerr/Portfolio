...
/**
 * Types out a block of lines one character at a time — the terminal's
 * signature effect. Respects `prefers-reduced-motion` by rendering the
 * full text immediately instead of a slower/shorter animation.
 */
