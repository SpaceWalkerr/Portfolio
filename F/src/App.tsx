...
function App() {
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:bg-ink focus:px-6 focus:py-3 focus:font-serif focus:text-sm focus:italic focus:text-paper focus:outline-none"
      >
